...
def normalize_download_csv_row(row: dict[str, str]) -> dict[str, Any] | None:
    """Map a GBIF SIMPLE_CSV (tab) row to the same dict shape as :func:`normalize_search_occurrence`."""
